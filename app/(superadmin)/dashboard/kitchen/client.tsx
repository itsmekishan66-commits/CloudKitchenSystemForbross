    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center justify-end gap-4">
          ...
          <button onClick={openCreate} className="rounded-xl bg-orange-500 px-5 py-3 text-white font-semibold hover:bg-orange-600">+ Add Kitchen</button>
        </div>
      </div>
            ...
            {filteredKitchens.length === 0 ? (
              ...
              filteredKitchens.map((kitchen) => (
                <tr key={kitchen.id} className="border-t">
                  ...
                  <td className="p-4">
                    <button onClick={() => openEdit(kitchen)} className="mr-2 rounded bg-blue-500 px-3 py-1 text-white text-sm hover:bg-blue-600">Edit</button>
                    <button onClick={() => handleDelete(kitchen.id)} className="rounded bg-red-500 px-3 py-1 text-white text-sm hover:bg-red-600">Delete</button>
                  </td>
                </tr>
              ))
            )}
